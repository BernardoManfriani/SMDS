...
ggplot() +
  ...
  geom_point(data = df, aes(x = data, y = nuovi_positivi, group = 1),col=col_zone[unclass(as.factor(df$color))], size=3)+
...
glm_mod7 <- glm(nuovi_positivi ~ new_color + ricoverati_con_sintomi + totale_ospedalizzati, data = df, family="poisson")

#glm_mod7 <- glm(nuovi_positivi ~ new_color_prev + ricoverati_con_sintomi_prev  + nuovi_tamponi_pcr_prev, data = df, family="poisson")
...
>>>>>>> c68e12ae19af2ecc0b51529d4a97d109d8792a93:Covid19_cleaned.Rmd
=======
---
title: "Covid-19 - SMSD"
output:
...
ggplot(data=d)+
  ...
  geom_stat(aes(x=data, y=nuovi_positivi))
...
>>>>>>> cb555d9f5fc7b39e9648e12d290fe9e1df3646ce:Covid19_cleaned.Rmd
