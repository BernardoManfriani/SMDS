...
library("Metrics")
#lm
1 - smape(predict(lm_mod5,type="response", newdata= df_extended[124:137,]), df_extended$nuovi_positivi[124:137])/2 # 0.666282

#glm poisson
1 - smape(predict(glm_mod5,type="response", newdata= df_extended[124:137,]), df_extended$nuovi_positivi[124:137])/2 # 0.6654311


#glm negative binomial
1 - smape(predict(nglmod5,type="response", newdata= df_extended[124:137,]), df_extended$nuovi_positivi[124:137])/2 # 0.6768924

#gam
1 - smape(predict(gam_mod1,type="response", newdata= df_extended[124:137,]), df_extended$nuovi_positivi[124:137])/2 # 0.7321824
...
library("Metrics")
#lm
1 - smape(predict(lm_mod,type="response", newdata= df_extended[124:137,]), df_extended$nuovi_positivi[124:137])/2 #0.898472

#glm poisson
1 - smape(predict(glm_mod,type="response", newdata= df_extended[124:137,]), df_extended$nuovi_positivi[124:137])/2 #0.9445152

#nglm
1 - smape(predict(nglm_mod,type="response", newdata= df_extended[124:137,]), df_extended$nuovi_positivi[124:137])/2 #0.9399573

#gam
1 - smape(predict(gam_mod,type="response", newdata= df_extended[124:137,]), df_extended$nuovi_positivi[124:137])/2 #0.9418422
...
lm_mod_google <- lm(nuovi_positivi ~ ricoverati_con_sintomi + nuovi_tamponi_pcr + new_color + var_station, data = df) 

glm_mod_google <- glm(nuovi_positivi ~ ricoverati_con_sintomi + nuovi_tamponi_pcr + new_color + var_station, data = df, family=poisson(link = "log"))
...
#lm
1 - smape(predict(lm_mod_google,type="response", newdata= df_extended[124:137,]), df_extended$nuovi_positivi[124:137])/2 #0.8932276

#glm poisson
1 - smape(predict(glm_mod_google,type="response", newdata= df_extended[124:137,]), df_extended$nuovi_positivi[124:137])/2 #0.9387667
