...
cols <- c("data","ricoverati_con_sintomi", "isolamento_domiciliare","nuovi_decessi", "terapia_intensiva", "nuovi_tamponi_pcr", "nuovi_positivi")
M=cor(corr_df[,cols])
...
ngl_mselm<-rbind(get_mse(nglmod1),get_mse(nglmod2),get_mse(nglmod3),get_mse(nglmod4),get_mse(nglmod5))

ngl_table <- data.frame(formula,nglaic[2], ngl_mselm)
...
>>>>>>> 95a6a671eb8b6e58bc88a4e440c1e80dcf230644
