...
```{r}
>>>>>>> ada05ec466acf60e5ee244a9d99355c297a2a464
require("MASS")
nrw<-length(df[,1])
...
ngb_compare <- compare_performance(nglmod1, nglmod2,nglmod3,nglmod4,nglmod5)
ngb_compare
...
glm_mod7 <- glm(nuovi_positivi ~ ( I(ricoverati_con_sintomi_prev^2)+ ricoverati_con_sintomi_prev  + I(nuovi_tamponi_pcr_prev^2) + nuovi_tamponi_pcr_prev )* color + data , data = df)
