...
```{r glm7, echo=FALSE, message=FALSE, warning=FALSE}

gmod7 <- glm(nuovi_positivi ~ terapia_intensiva * color + data + terapia_intensiva_prev*color + nuovi_tamponi*color, data = df, family=poisson(link = "log"))
...
```{r comparison}
AIC(gmod1, gmod2, gmod3, gmod4, gmod5, gmod6, gmod7)
```